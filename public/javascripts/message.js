        ...
        <b-tabs card>
          <b-tab v-for="(image, imgkey) in element.images">
            ...
            <b-card-text>
              ...
              <b-button :disabled="image.card_suggestions && image.card_suggestions.length >= 4" v-on:click="addCardSuggestion(imgkey)" variant="outline-info" size="sm" href="#">New Card Suggestion</b-button>
...
Vue.component('element-standalone', {
  ...
  <div>
    ...
    <b-button :disabled="element.card_suggestions && element.card_suggestions.length >= 4" v-on:click="addCardSuggestion(sidx)" variant="outline-info" size="sm" href="#">New Card Suggestion</b-button>
